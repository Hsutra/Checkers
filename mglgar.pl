...
board_print(game_board(A,B,C,D,E,F,G,H)):-
	open('board.txt', write, Stream3),
	% tab(3),print(1), tab(2),print(2), tab(2),
	% print(3), tab(2),print(4), tab(2),
	% print(5), tab(2),print(6), tab(2),
	% print(7), tab(2),print(8), tab(2), nl,
	% print(1), tab(2),
	board_print_line(Stream3,A),
	% print(2), tab(2),
	board_print_line(Stream3,B),
	% print(3), tab(2),
	board_print_line(Stream3,C),
	% print(4), tab(2),
	board_print_line(Stream3,D),
	% print(5), tab(2),
	board_print_line(Stream3,E),
	% print(6), tab(2),
	board_print_line(Stream3,F),
	% print(7), tab(2),
	board_print_line(Stream3,G),
	% print(8), tab(2),
	board_print_line(Stream3,H),
	close(Stream3).

% board_print_line(+Line).
% Auxiliary function that prints a line of the board.
board_print_line(Stream3,Line):-
	board_print_line_element(Stream3,Line,1),
	board_print_line_element(Stream3,Line,2),
	board_print_line_element(Stream3,Line,3),
	board_print_line_element(Stream3,Line,4),
	board_print_line_element(Stream3,Line,5),
	board_print_line_element(Stream3,Line,6),
	board_print_line_element(Stream3,Line,7),
	board_print_line_element(Stream3,Line,8),
	nl(Stream3).

board_print_line_element(Stream3,Line,Index):-
	arg(Index,Line,E),
	E == 1, !,
	%format('~c',[9632]), % black square
	format(Stream3,'~c',[95]),	% underscore
	tab(Stream3,2).
board_print_line_element(Stream3,Line,Index):-
	arg(Index,Line,E),
	E == 0, !,
	tab(Stream3,2).			% just a white space
board_print_line_element(Stream3,Line,Index):-
	arg(Index,Line,E),
	E == w, !,
...
board_print_line_element(Stream3,Line,Index):-
	arg(Index,Line,E),
	print(Stream3,E),		% shouldn't reach this state
	tab(Stream3,2).
...
print_possible_moves(Stream2, _, []) :- !,  nl.

print_possible_moves(Stream2, Num, [m(X1,Y1,X2,Y2,_)|Moves]) :- !, 
	write(Stream2, Num), write(Stream2, ': ('), write(Stream2, X1), write(Stream2, ','), write(Stream2, Y1),
	write(Stream2, ') -> ('),
	write(Stream2, X2), write(Stream2, ','), write(Stream2, Y2), write(Stream2, ')'), nl(Stream2),
	NextNum is Num + 1,
	print_possible_moves(Stream2, NextNum, Moves).


print_possible_moves(Stream2, Num, [Chain|Moves]) :- !, 
	write(Stream2, Num), write(Stream2, ': '),
	print_chain_moves(Stream2, Chain),
	NextNum is Num + 1,
	print_possible_moves(Stream2, NextNum, Moves).

print_chain_moves(Stream2, [e(X1,Y1,X2,Y2,_)]) :- !, 
	write(Stream2, '('), write(Stream2, X1), write(Stream2, ','), write(Stream2, Y1),
	write(Stream2, ') -> ('),
	write(Stream2, X2), write(Stream2, ','), write(Stream2, Y2), write(Stream2, ')'), nl(Stream2).

print_chain_moves(Stream2, [e(X1,Y1,X2,Y2,_)|Chain]) :- !, 
	write(Stream2, '('), write(Stream2, X1), write(Stream2, ','), write(Stream2, Y1),
	write(Stream2, ') -> ('),
	write(Stream2, X2), write(Stream2, ','), write(Stream2, Y2), write(Stream2, ') -> '),
	print_chain_moves(Stream2, Chain).

print_move(Stream, m(X1, Y1, X2, Y2, _)) :- !, 
	write(Stream, '('), write(Stream, X1), write(Stream, ','), write(Stream, Y1),
	write(Stream, ') -> ('),
	write(Stream, X2), write(Stream, ','), write(Stream, Y2), write(Stream, ')'), nl(Stream).
print_move(Stream, e(X1, Y1, X2, Y2, _)) :- !, 
	write(Stream, '('), write(Stream, X1), write(Stream, ','), write(Stream, Y1),
	write(Stream, ') -> ('),
	write(Stream, X2), write(Stream, ','), write(Stream, Y2), write(Stream, ')'), nl(Stream).
...
make_play(black,Board) :-
    ...
    open('pos_moves.txt', write, Stream2),
    print_possible_moves(Stream2, 1, Moves),
    close(Stream2).
